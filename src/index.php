...
<body>
    <div id="profilAndCart">
        <?php if(isset($_SESSION['user_id'])){
            echo '<a href="index.php?page=cart"><svg class="w-[40px] h-[40px] text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
