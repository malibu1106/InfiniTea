...
<?php
    foreach ($thes_vert as $the_vert){
      ...
      echo '<div class="hiddenProduct w-full sm:w-80 md:w-80 lg:w-80 xl:w-80 min-w-20  mb-4 flex flex-col items-center bg-stone-100 p-4 rounded-lg shadow-md">';
      echo '<h3 class="sm:text-5xl md:text-5xl lg:text-5xl xl:text-6xl mb-1">'.$the_vert['name'].'</h3>';
