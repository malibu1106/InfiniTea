...
<form method="POST" action="pages/signup.php" enctype="multipart/form-data"class="max-w-md mx-auto">
...
<option>Non renseigné</option>
 ...
 <button type="submit" class="text-white font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-purple-900 dark:hover:bg-pink-500 my-2">Inscription</button>
</form>