<h3>Connec thé-vous</h3>
<form method="POST" action="index.php" enctype="multipart/form-data"class="max-w-md mx-auto">
<div class="relative z-0 w-full mb-5 group">
  ...
  <button type="submit" class="text-white font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-purple-900 dark:hover:bg-pink-500 my-2">Connexion</button> 
  

  <p class="text-gray-500 dark:text-gray-400">Vous n'êtes pas encore inscrit ? <a href="#" class="inline-flex items-center font-medium text-pink-500  hover:underline">
Rejoignez-nous!
</a></p>
